...
{
    public partial class ADMIN_int_SchoolUnif_ : Form
    {
        ...
        public void LoadProductsToDashboard1()
        {
            try
            {
                ...
                {
                    connection.Open();
                    string query = "SELECT Product_ID, Product_name, Price_Size_VS, Price_Size_S, Price_Size_M,Price_Size_L,Price_Size_XL,Picture, stock_status FROM Products_Size WHERE Category = 'School' ";
        ...
        public void LoadProductsToDashboard()
        {
            try
            {
                ...
                {
                    connection.Open();
                    string query = "SELECT product_id, product_name, product_price, product_image, stock_status FROM products WHERE category = 'School Uniform'";
                    OleDbCommand command = new OleDbCommand(query, connection);
                    OleDbDataReader reader = command.ExecuteReader();
        ...
        private void ADMIN_int_SchoolUnif__Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (OleDbConnection connection = new OleDbConnection(connectionString))
                {
                    ...
                    string searchQuery = "SELECT product_id, product_name, product_price, product_image, stock_status " +
                                         "FROM products WHERE category = 'School Uniform' AND product_name LIKE @searchText";
