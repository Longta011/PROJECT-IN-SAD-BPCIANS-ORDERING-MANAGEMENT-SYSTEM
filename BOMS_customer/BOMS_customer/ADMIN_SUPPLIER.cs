...
namespace BOMS_customer
{
    public partial class ADMIN_SUPPLIER : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(tbN.Text) || string.IsNullOrWhiteSpace(tbC.Text) ||
                string.IsNullOrWhiteSpace(tbA.Text) || string.IsNullOrWhiteSpace(tbP.Text))
            ...
            string query = "INSERT INTO SUPPLIER (SUPPLIER_NAME,SUPPLIER_CONTACT,SUPPLIER_ADDRESS, PRODUCT) " +
                           "VALUES (@n, @c,@a, @p)";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            string query = isImageUploaded
                ? "UPDATE SUPPLIER SET SUPPLIER_NAME=@n, SUPPLIER_CONTACT=@c,SUPPLIER_ADDRESS=@a, PRODUCT=@p WHERE SUPPLIER_ID=@id"
                : "UPDATE SUPPLIER SET SUPPLIER_NAME=@n, SUPPLIER_CONTACT=@c,SUPPLIER_ADDRESS=@a, PRODUCT=@p WHERE SUPPLIER_ID=@id";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string query = "DELETE FROM SUPPLIER WHERE SUPPLIER_ID = @i";
        ...
        private void dgvUser_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            tbC.Text = dgvUser.CurrentRow.Cells[2].Value.ToString();
            tbA.Text = dgvUser.CurrentRow.Cells[3].Value.ToString();
        ...
        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            ...
            adapter.SelectCommand.Parameters.AddWithValue("@i", textBox6.Text + "%");
